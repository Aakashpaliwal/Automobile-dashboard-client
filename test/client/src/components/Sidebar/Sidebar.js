    ...
    render() {
        return (
          ...
          <span>John Doe</span>
                        ...
                        <li> <a className="has-arrow waves-effect waves-dark" href="#product" data-toggle="collapse" data-target="#product"><i className="fa fa-file-text-o" aria-hidden="true"></i><span className="hide-menu">Product</span></a>
                            <ul aria-expanded="false" className="collapse" id="product">
                            <Link to ="/AddProduct"><li><i className="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp;Add Product</li></Link>
                            <Link to ="/ProductTable"><li><i className="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp;View Product</li></Link>
